      ...
      _aboutPage(new AboutPage(this))
{
    ...
    _titleBar->resize(this->width(), _titleBarHeight);
    _titleBar->move(0, 0);
    _tabWidget->move(0, _titleBarHeight);
    _tabWidget->resize(this->width(), this->height() - _titleBarHeight);
    _indexPage->resize(this->width(), this->height() - _titleBarHeight);
